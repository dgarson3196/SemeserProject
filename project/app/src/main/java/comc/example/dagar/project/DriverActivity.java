...
public class DriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(comc.example.dagar.project.R.layout.activity_driver);
        ...
        firebaseauthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                //if user exists move to driver map
                if(user !=null){
        ...
        mEmail = (EditText) findViewById(comc.example.dagar.project.R.id.email);
        mPassword = (EditText) findViewById(comc.example.dagar.project.R.id.password);
        mLogin = (Button) findViewById(comc.example.dagar.project.R.id.login);
